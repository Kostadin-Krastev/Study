...
const myCountry = {
  ...
  calcPopulation: function (population) {
...
console.log(
  `${myCountry.country} has ${myCountry.calcPopulation(6000000)} million ${
    myCountry.language
  }-speaking people, and ${
    myCountry.neighbours.length
  } neighbours countries and a capital called ${myCountry.capital}`
);

// Task 2: A) increasing the country population by two million using dot notaion
// console.log(
//   `${myCountry.country} has ${myCountry.calcPopulation(6000000)} million ${myCountry.language}-speaking people, and ${myCountry.neighbours.length} neighbours countries and a capital called ${myCountry.capital}`
